create or replace package body wksp_ebs2cloud_migration.xx_mig_tool_pkg as

    procedure xx_url_state as
        x_url         varchar2(300);
...
-- sqlcl_snapshot {"hash":"e6335f92b8296fdb398f8910facb44fcd5b39ef5","type":"PACKAGE_BODY","name":"XX_MIG_TOOL_PKG","schemaName":"WKSP_EBS2CLOUD_MIGRATION","sxml":""}